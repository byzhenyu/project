...
class CompanyInfoModel extends Model {
    protected $insertFields = array('user_id,company_name,company_size,company_nature,company_mobile,company_email,company_industry,company_address,company_pic');
    protected $updateFields = array('user_id,company_name,company_size,company_nature,company_mobile,company_email,company_industry,company_address,company_pic');
    protected $_validate = array(
        array('company_name', 'require', '公司名称不能为空！', 1, 'regex', 3),
        array('company_name', '1,100', '公司名称保持在1-100字！', 1, 'regex', 3),
        array('company_size', 'require', '请选择公司规模！', 1, 'regex', 3),
        ...
        array('company_address', '1,150', '公司名称保持在1-150字！', 1, 'regex', 3),
    );
