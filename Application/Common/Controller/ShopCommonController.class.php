...
{   
    public function __construct()
    {
        ...
        $shop_auth = session('shop_auth');
        $shop_id = $shop_auth['shop_id'];
        $shop_id = $shop_id ? $shop_id : 0;
        $shopName = $shop_auth['shop_name'] ? $shop_auth['shop_name'] : 0;
        define('SHOP_ID', $shop_id);
        define('SHOP_UID', $shop_auth['uid']);
        define('SHOP_NAME', $shopName);
        define('AGENT_ID', $shop_auth['agent_id']);
